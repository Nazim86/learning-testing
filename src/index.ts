...
// export const getNews = app.get('/news/categories', (req: Request, res: Response) => {
//     return (newsCategories.map(c => ({ title: c.title })))
//     // console.log(newsCategories.map(c => ({ title: c.title })))
// })
//
